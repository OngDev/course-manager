...
const VideoViewer: React.FC<IProps> = ({urlVideo}) => {
    ...
    return (
        <div className={style.VideoDetailWrapper}>
            <video className={style.VideoDetail} src={urlVideo} ref={videoRef}></video>
            <div className={style.Control}>
                <span onClick={startVideo}><img src={isVideoStarted ? STOP : START} alt="stop" /></span>
                ...
                <span onClick={toggleVolume}><img src={isVolumeMuted ? MUTED_VOLUME : VOLUME} alt="volume" /></span>
